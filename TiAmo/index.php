<?php
/**
 * TiAmo 基于chivalric模板且以科学、高端为主,采用兼容性开发!
 * 
 * @package TiAmo
 * @author 权那他
 * @version 1.0.1
...
<section class="row content-wrap">
    <div class="container">
        <div class="row" id="post-masonry">
            ...
            <?php if($this->is('index') & $this->_currentPage==1 || $this->is('author')):?>
            <!--Author Widget-->
            <?php echo widget_author('col-sm-4 widget-author widget widget-with-posts post dispmin','index',$this->author->screenName,$this->author->name,$this->options->describes,$this->author->mail,$this->author->permalink,$this->options->socialnav);?>
            <?php endif;?>
            
            <?php if ($this->have()): ?>
            <?php while($this->next()): $format = tiamos_Plugin::getFormat();?>
