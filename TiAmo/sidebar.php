...
<!--Author Widget-->
<?php echo widget_author('row m0 widget-author widget','post',$this->author->screenName,$this->author->name,$this->options->describes,$this->author->mail,$this->author->permalink,$this->options->socialnav);?>
